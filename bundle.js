...
/***/ function(module, exports, __webpack_require__) {
	...
	var _search_page = __webpack_require__(189);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_search_page2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _search_results = __webpack_require__(208);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement('input', { className: 'col-md-4 m-a-2', type: 'text', value: this.state.term, onChange: function onChange(event) {
	                return _this2.onInputChange(event.target.value);
	              } }),
	            _react2.default.createElement('input', { type: 'button', className: 'col-md-1 btn btn-primary m-a-2', value: 'Search', onClick: this.onButtonClick })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	...
	function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ searchTag: _index.searchTag }, dispatch);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SEARCH_TAG = exports.SEARCH_TAG = 'SEARCH_TAG';

	var ROOT_URL = 'http://pacific-shore-18608.herokuapp.com/api';

	function searchTag(tag) {
	  var url = ROOT_URL + '?tag=' + tag;
	...
	var SearchResults = function (_Component) {
	  ...
	  _createClass(SearchResults, [{
	    ...
	    value: function renderResult(result) {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'col-md-4', key: result._id },
	        _react2.default.createElement(
	          'div',
	          null,
	          _react2.default.createElement('image', { src: result.image, width: '304', height: '236' })
	        ),
	        _react2.default.createElement(
	          'div',
	          null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer_search_results = __webpack_require__(210);

	var _reducer_search_results2 = _interopRequireDefault(_reducer_search_results);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  searchResults: _reducer_search_results2.default
	});
